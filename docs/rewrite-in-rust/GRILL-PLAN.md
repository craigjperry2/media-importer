...
• Zero-Collision Storage: Use BLAKE3 for addressing. Store blobs in a 2-level hex-prefix directory (16^2 \times 16^2 fan-out).
...
• Expose a narrow CLI surface: import, build-tree, gc, audit.
